...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM5_MspInit 0 */
    ...
    PA3     ------> TIM5_CH4
    */
    GPIO_InitStruct.Pin = MOTOR1A_INPUT_Pin|MOTOR2A_INPUT_Pin|MOTOR3A_INPUT_Pin|MOTOR4A_INPUT_Pin;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = PWM_SERVO3_Pin|PWM_SERVO4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA3     ------> TIM5_CH4
    */
    HAL_GPIO_DeInit(GPIOA, MOTOR1A_INPUT_Pin|MOTOR2A_INPUT_Pin|MOTOR3A_INPUT_Pin|MOTOR4A_INPUT_Pin);
